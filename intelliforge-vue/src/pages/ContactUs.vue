<template>
  <div>
    <PageHero title="Contact Us" subtitle="We'd love to hear from you. Get in touch with IntelliForge today." :breadcrumb="[{ name: 'Home', path: '/' }, { name: 'Contact Us' }]" />
    <section class="py-20"><div class="container-main">
